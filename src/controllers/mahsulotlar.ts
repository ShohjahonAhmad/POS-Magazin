...
export const getMahsulotlar: RequestHandler = async (req, res) => {
...
export const createMahsulot: RequestHandler = async (req, res) => {
...
export const getMahsulot: RequestHandler<{id: string}> = async (req, res) => {
...
export const updateMahsulot: RequestHandler = async (req, res) => {
    const mahsulotId = req.params.id;
    const { kategoriya, ...rest } = req.body;
