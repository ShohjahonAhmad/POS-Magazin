...
export const getSotuvlar = async (req, res, next) => {
    const month = parseInt(req.query.oy);
    const year = parseInt(req.query.yil);
    console.log(year);
    let whereClause = {};
...
export const getSotuv = async (req, res, next) => {
...
export const updateSotuv = async (req, res, next) => {
    const id = parseInt(req.params.id);
...
export const deleteSotuv = async (req, res, next) => {
    const id = parseInt(req.params.id);
    const oldSotuv = await prisma.sotuv.findUnique({
        where: { id }
    });
